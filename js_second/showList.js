...
function showList(__listSize, __dataSize, __position, __startplace, __f){
	...
	this.up = this.focusUp  = function(){this.changeList(-1);}; //焦点向上移动；
	this.down = this.focusDown = function(){this.changeList(1); }; //焦点向下移动；
	this.left = this.focusLeft  = function(){this.changeList(-1);}; //焦点向左移动；
	this.right = this.focusRight = function(){this.changeList(1); }; //焦点向右移动；
